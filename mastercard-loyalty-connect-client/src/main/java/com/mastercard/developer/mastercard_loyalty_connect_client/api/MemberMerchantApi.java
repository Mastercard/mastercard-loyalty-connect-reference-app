...
public class MemberMerchantApi {
    ...
    public MemberMerchantLoyaltyDetails getMemberMerchantLoyaltyProgram(String memberReferenceId, String memberMerchantReferenceId, String xMerchantKey) throws ApiException {
        ApiResponse<MemberMerchantLoyaltyDetails> resp = getMemberMerchantLoyaltyProgramWithHttpInfo(memberReferenceId, memberMerchantReferenceId, xMerchantKey);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMemberMerchantLoyaltyProgramAsync(String memberReferenceId, String memberMerchantReferenceId, String xMerchantKey, final ApiCallback<MemberMerchantLoyaltyDetails> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateMerchantLoyaltyProgramCall(String memberReferenceId, String memberMerchantReferenceId, LoyaltyProgram loyaltyProgram, String xMerchantKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateMerchantLoyaltyProgramValidateBeforeCall(String memberReferenceId, String memberMerchantReferenceId, LoyaltyProgram loyaltyProgram, String xMerchantKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateMerchantLoyaltyProgramCall(memberReferenceId, memberMerchantReferenceId, loyaltyProgram, xMerchantKey, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> updateMerchantLoyaltyProgramWithHttpInfo(String memberReferenceId, String memberMerchantReferenceId, LoyaltyProgram loyaltyProgram, String xMerchantKey) throws ApiException {
        com.squareup.okhttp.Call call = updateMerchantLoyaltyProgramValidateBeforeCall(memberReferenceId, memberMerchantReferenceId, loyaltyProgram, xMerchantKey, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateMerchantLoyaltyProgramAsync(String memberReferenceId, String memberMerchantReferenceId, LoyaltyProgram loyaltyProgram, String xMerchantKey, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateMerchantLoyaltyProgramValidateBeforeCall(memberReferenceId, memberMerchantReferenceId, loyaltyProgram, xMerchantKey, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
