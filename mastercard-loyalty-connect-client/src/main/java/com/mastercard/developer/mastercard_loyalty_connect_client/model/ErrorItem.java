...
public class ErrorItem {
  ...
  public ErrorItem description(String description) {
   ...
   /**
   * Detailed explanation of a specific error
   * @return description
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Invalid request", value = "Detailed explanation of a specific error")
  ...
  public ErrorItem addDetailsItem(DetailItem detailsItem) {
   ...
   /**
   * Field and data level details of the error
   * @return details
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Field and data level details of the error")
