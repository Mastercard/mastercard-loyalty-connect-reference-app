...
public class PaymentCardDetails {
  ...
  public PaymentCardDetails bankCardNumber(String bankCardNumber) {
   ...
   /**
   * Masked Payment Card number connected by the user in MLC
   * @return bankCardNumber
  **/
  @ApiModelProperty(example = "XXXXXXXXXXXX4444", required = true, value = "Masked Payment Card number connected by the user in MLC")
