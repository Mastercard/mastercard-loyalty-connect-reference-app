...
public class MemberApi {
    ...
    /**
     * Build call for searchMember
     * @param xMerchantKey Key assigned to a &#39;Merchant&#39; Business Partner at the time of onboarding (required)
     * @param memberSearch In order to search a member, user ID attributes must be provided (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call searchMemberCall(String xMerchantKey, MemberSearch memberSearch, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = memberSearch;

        // create path and map variables
        String localVarPath = "/members/searches";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchMemberValidateBeforeCall(String xMerchantKey, MemberSearch memberSearch, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'xMerchantKey' is set
        if (xMerchantKey == null) {
            throw new ApiException("Missing the required parameter 'xMerchantKey' when calling searchMember(Async)");
        }
        
        // verify the required parameter 'memberSearch' is set
        if (memberSearch == null) {
            throw new ApiException("Missing the required parameter 'memberSearch' when calling searchMember(Async)");
        }
        

        okhttp3.Call localVarCall = searchMemberCall(xMerchantKey, memberSearch, _callback);
        return localVarCall;
     ...
     */
    public MemberResponse searchMember(String xMerchantKey, MemberSearch memberSearch) throws ApiException {
        ApiResponse<MemberResponse> localVarResp = searchMemberWithHttpInfo(xMerchantKey, memberSearch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MemberResponse> searchMemberWithHttpInfo(String xMerchantKey, MemberSearch memberSearch) throws ApiException {
        okhttp3.Call localVarCall = searchMemberValidateBeforeCall(xMerchantKey, memberSearch, null);
        Type localVarReturnType = new TypeToken<MemberResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search a member (asynchronously)
     * Search a member in MLC. Every member is identified by the user id
     * @param xMerchantKey Key assigned to a &#39;Merchant&#39; Business Partner at the time of onboarding (required)
     * @param memberSearch In order to search a member, user ID attributes must be provided (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call searchMemberAsync(String xMerchantKey, MemberSearch memberSearch, final ApiCallback<MemberResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchMemberValidateBeforeCall(xMerchantKey, memberSearch, _callback);
        Type localVarReturnType = new TypeToken<MemberResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
